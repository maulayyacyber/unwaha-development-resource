        ...
        <div class="col-md-12">
            ...
            <div class="portlet box blue">
                        <div class="portlet-title">
                                <div class="caption">
                                        <i class="fa fa-bookmark-o"></i>Data Menu
                                </div>
                                <div class="tools">
           ...
           <div id="navbar-guru" class="navbar navbar-default" role="navigation">
                ...
                <div class="collapse navbar-collapse navbar-ex1-collapse">
                        <form class="navbar-form navbar-left form-inline" role="form" method="post" action="<?php print base_url(); ?>admin/konten/menu/search">
                                <div class="form-group">
                                        <div class="input-medium">
                                                <input type="text" class="form-control" name="data_menu" placeholder="Cari judul atau isi" autocomplete="off">
                                        </div>
                                </div>

...
<div class="container content">
  <form action="<?php print base_url()?>web/pengumuman/search" method="POST">
    <div class="input-group margin-bottom-40">
        <input type="text" name="cari_pengumuman" autocomplete="off" class="form-control" placeholder="Cari Pengumuman FTI UNWAHA">
  ...
  <div class="row blog-page">
      ...
      <div class="col-md-9">
        <!--Blog Post-->
          <div class="headline headline-md"><h2><i class="icon-pin"></i> Pengumuman Terbaru</h2></div>

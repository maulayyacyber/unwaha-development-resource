...
<div class="container content">
  <form action="<?php print base_url()?>web/artikel/search" method="POST">
    <div class="input-group margin-bottom-40">
        <input type="text" name="cari_artikel" autocomplete="off" class="form-control" placeholder="Cari Artikel FTI UNWAHA">
  ...
  <div class="row blog-page">
      ...
      <div class="col-md-9">
        <!--Blog Post-->
          <div class="headline headline-md"><h2><i class="fa fa fa-book"></i> Artikel Terbaru</h2></div>
